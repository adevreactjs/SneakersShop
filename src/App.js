    ...
    <div className="wrapper clear">
      <div className="overlay">
        <div className="drawer">
          <h2 className="d-flex justify-between mb-30">Корзина<img className="remove-btn cu-p" src="/img/btn-delete.svg" alt="img"/></h2>
      ...
      <header className="d-flex justify-between align-center" >
       ...
       <img width={40} height={40} src="/img/logo.png"></img>
        ...
        <ul className="d-flex">
          ...
          <li>
              <svg className="mr-36" width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="d-flex align-center justify-between mb-40">
         ...
         <img width={133} height={112} src="/img/cross.jpg" alt="cross"/>
          ...
          <div className="card">
            ...
            <img width={133} height={112} src="/img/cross-2.jpg" alt="cross"/>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className="d-flex justify-between align-center">
                <div className ="d-flex flex-column ">
                <p>Цена:</p>
            ...
            <img width={133} height={112} src="/img/cross-3.jpg" alt="cross"/>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className="d-flex justify-between align-center">
                <div className ="d-flex flex-column ">
                <p>Цена:</p>
